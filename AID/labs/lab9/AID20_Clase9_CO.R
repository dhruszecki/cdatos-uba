...
####################################
####################################
#Ejemplo 2: Muestras independientes de poblaciones cualesquiera

#Supongamos que m1 es una muestra de edades de personas que solicitan crédito en el Banco Sur, y m2 es una 
#muestra de edades de personas que solicitan crédito en el Banco Norte. Se sabe que estas personas son clientes 
#de un único banco, por lo que no existe la posibilidad de que hayan pedido el crédito en ambas entidades. 
#Se quiere analizar si la edad promedio de los clientes que solicitan crédito en el Banco Sur es similar a la 
#edad promedio de los clientes que solicitan crédito en el Banco Norte.
...
####################################
####################################
#Ejemplo 3: Muestras apareadas (dependientes)
...
#a cronometrar a esos mismos 10 corredores. Suponiendo que los tiempos tienen distribución normal, y en vista de 
#los datos obtenidos ¿hay diferencia significativa entre el rendimiento de los corredores tras un año de entrenar 
...
####################################
####################################
#Ejemplo 4: Tests no paramétricos de Mann Whitney Wilcoxon y de la Mediana para 2 muestras independientes
