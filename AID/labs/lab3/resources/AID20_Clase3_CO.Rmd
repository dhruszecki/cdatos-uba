...
# otra forma de hacer lo mismo es usando scale
# scale transforma los datos (de las columnas de una matriz dada) para obtener media 0 y desvío 1
estandarizoFil<-scale(t(recep[,-1]),center=T,scale=TRUE)# Notar que se transpone para afectar las filas originales del objeto recep
