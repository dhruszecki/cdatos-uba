...
<center> <h1>Introducción al lenguaje R</h1> </center> 
<br>
<br>

### <span style="color:darkred">Selección del directorio de trabajo</span>
<br>
...
### <span style="color:darkred">Asignación a variables, vectores y operaciones</span>
<br>
```{r echo=TRUE}
...
####</span>Ejercicio 1: Calcular la media y mediana del vector x y el número de valores que están por debajo de la media y de la mediana, siendo x=c(1,5,7,9,3,5,6,2,4,7,5,6,9,8,6,2,6,1,4).</span>
<br>
<br>


### <span style="color:darkred">For, If y funciones</span>
<br>
```{r echo=TRUE}
#Uso de for:
...
####</span>Ejercicio 2: Escribir la función que calcula el módulo de un número real.</span>
<br>

####</span>Ejercicio 3: Usar for para hallar el resultado de dividir de manera consecutiva el número 1111 por los siguientes divisores (en este orden): 2, 3, 4, 5, 6.</span>
<br>

####</span>Ejercicio 4: Escribir una función que responda el signo del producto de dos factores dado, es decir "Positivo", o "Negativo", y en el caso que el producto sea 0 devuelva "Nulo".</span>

<br>
<br>

### <span style="color:darkred">Matrices y operaciones</span>
<br>
```{r echo=TRUE}
...
### <span style="color:darkred">Función sample</span>
<br>
```{r echo=TRUE}
sample(c(1,2,3), size=2, replace=FALSE)#muestra aleatoria simple a partir de un vector de valores con o sin reemplazamiento

#vector de valores sin reemplazo
sample(1:100, size=50, replace=FALSE)# es igual que sample(100,50,FALSE)

#vector de valores con reemplazo
...
####</span>Ejercicio 5: Simular el lanzamiento de un dado.</span>
<br>

####</span>Ejercicio 6: Simular el lanzamiento de cuatro dados o de un mismo dado cuatro veces.</span>
<br>

####</span>Ejercicio 7: Supongamos una urna con 3 bolas blancas y 7 negras, simular la extracción de una bola (asignar, por ejemplo, el 1 a bola blanca y 0 a negra).</span>
<br>

####</span>Ejercicio 8: Simular 8 extracciones con reemplazamiento de la urna del ejercicio 7.</span>
